...
//  PlayingCard
//
//  Created by YUGWANGYONG on 03/10/2018.
//  Copyright © 2018 Gwang Y. All rights reserved.
//

import UIKit

// Main.storyboard 에서 빌드 결과 볼 수 있는 어노테이션
@IBDesignable
class PlayingCardView: UIView {

    // Only override draw() if you perform custom drawing.
    // An empty implementation adversely affects performance during animation.
    // Main.storyboard 에서 옵션으로 사용할 수 있는 어노테이션
    @IBInspectable
    ...
    override func draw(_ rect: CGRect) {
        ...
        // Main.storyboard -> Drawing Opaque unChecked
...
//        }
        ...
        // Modify :: Main.storyboard -> Content mode -> reDraw
        // Center Circle, Red Line, GreenColor
